...
GET_POI_SUGGESTIONS_2 = "User is traveling to {point_of_interest}. User's current interests include {interests}, and sightseeing. Identify other major tourist attractions that align with the user's interests within a few hours. Then return a bullet point list of just the top 12 other attractions. Do not add any description or other information.\nFormat:\n - {major_attraction}"
