...
GET_POI_SUGGESTIONS_1 = "User is traveling to {region}. User's current interests include sightseeing, {interests}. Identify the major tourist attractions in this region and that align with the user's interests. Then return a bullet point list of just the top 12 attractions. Do not add any description or other information.\nFormat:\n - {major_attraction}"

GET_POI_SUGGESTIONS_2 = "User is traveling to {point_of_interest}. User's current interests include sightseeing, {interests}. Identify other major tourist attractions within a few hour journey by car/train of this point that align with the user's interests. Then return a bullet point list of just the top 12 other attractions. Do not add any description or other information.\nFormat:\n - {major_attraction}"
