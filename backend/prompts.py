...
GET_POI_SUGGESTIONS_2 = "User is traveling to {point_of_interest}. User's current interests include {interests}, and sightseeing/touristing. Identify other major tourist attractions that align with the user's interests around the point of interest these could be in the same country, orr bordering country if the destinations are still relatively close. Then return a bullet point list of just the top 12 other attractions. Do not add any description or other information.\nFormat:\n - {major_attraction}"
